...
export const CAMERA_CONTENT_BOUNDS_EMPTY_FALLBACK = 0;
export const CAMERA_DEFAULT_HORIZONTAL_OFFSET_FRACTION = -0.05;
export const CAMERA_DEFAULT_VERTICAL_OFFSET_FRACTION = 0.3;
...
export const IDLE_CHAT_ATTEMPT_MIN_SEC = 6.0;
export const IDLE_CHAT_ATTEMPT_MAX_SEC = 14.0;
export const IDLE_CHAT_DURATION_SEC = 6.0;
export const IDLE_CHAT_LINE_INTERVAL_SEC = 1.8;
export const IDLE_CHAT_COOLDOWN_MIN_SEC = 12.0;
export const IDLE_CHAT_COOLDOWN_MAX_SEC = 24.0;
export const IDLE_CHAT_MAX_DISTANCE_TILES = 4;
export const CHAT_BUBBLE_MAX_WIDTH_PX = 92;
